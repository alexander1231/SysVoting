...
class DetailView(TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # print(request.POST)
            # print(poll.question.answers.all().values('id'))
            # print(poll.question.answers.all())

            # print(request.POST.get('answer'))
            # print(type(request.POST.get('answer')))

            # El [0] esta demás u.u
            # el get te devuelve el único valor en la lista de
